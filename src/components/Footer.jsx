...
const Footer = () => {
  return (
    <footer className="bg-black p-9">
      ...
      <div className="text-white text-center flex justify-center pt-5">
  ...
  return (
    <div className="text-white">
      ...
      <form className="flex gap-4">
        <input
          type="text"
          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-black focus:border-blue-500 block w-full ps-3 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white "
  ...
  return (
    <div className="text-white">
      <div className="flex flex-col gap-2">
        ...
        <a className="text-[19px]" href={'telephone'}>
          +44 221 133 5360
        </a>
        <a className="text-[19px]" href="mail:customercare@mettamuse.com">
      ...
      <div className="my-4">
        ...
        <div className="flex mx-1 items-center">
          <Image
            className="w-5 mr-1 my-4"
            src={'/assets/payment/us.svg'}
            alt="logo"
            width={24}
            height={18}
          />
  ...
  return (
    <div className="text-white">
      <div className="hidden md:block">
        ...
        <ul>
          {links.map((link, i) => (
            <li key={i} className="my-2 text-lg">
              <a href="#">{link.text}</a>
            </li>
          ))}
        </ul>
  ...
  return (
    <div className="my-12">
      ...
      <div className="text-white flex">
        <Image
          className="w-6 mx-1 h-6 md:w-9 md:h-9"
